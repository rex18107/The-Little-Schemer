...
(rempick 3 '(a b c d e f)); (a b d e f)
; 移除列表lat里的所有数字元素
(define (no_nums lat)
  (cond
    ((null? lat) '())
...
(no_nums '(apple 2 3 red sweet 4)); (apple red sweet)
...
(all_nums '(apple 2 3 red sweet 4)); (2 3 4)
; 判断a1与a2是否相等
(define (eqan? a1 a2)
  (cond
